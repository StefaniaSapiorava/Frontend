...
public class ConnectionPool {
    ...
    private ConnectionPool() throws ConnectionPoolExceptions {
        try {
            ...
            throw new ConnectionPoolExceptions("Ошибка при инициализации пула соединений", e);
        }
    }

    public static ConnectionPool getInstance() throws ConnectionPoolExceptions {
        if (instance == null) {
    ...
    public Connection getConnection() throws ConnectionPoolExceptions {
        ...
        try {
            if (availableConnections.isEmpty()) {
                throw new ConnectionPoolExceptions("No available connections.");
            }
