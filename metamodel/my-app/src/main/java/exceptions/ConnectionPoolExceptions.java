...
public class ConnectionPoolExceptions extends Exception {
    private static final Logger logger = LogManager.getLogger(ConnectionPoolExceptions.class);
    private String connectionUrl;
    private String username;

    public ConnectionPoolExceptions(String message) {
        super(message);
        logError(message);
    }

    public ConnectionPoolExceptions(String message, Throwable cause) {
        super(message, cause);
        logError(message, cause);
    }

    // Конструктор с сообщением, URL подключения и именем пользователя
    public ConnectionPoolExceptions(String message, String connectionUrl, String username) {
        super(message);
    ...
    public ConnectionPoolExceptions(String message, Throwable cause, String connectionUrl, String username) {
        super(message, cause);
        this.connectionUrl = connectionUrl;
        this.username = username;
        logError(message, cause);
